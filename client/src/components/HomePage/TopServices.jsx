      ...
      <div className="flex justify-between mt-10">
        <div className="rounded-md overflow-hidden border border-[#CCD0D7]">
          ...
          <div className="p-2 md:p-5 bg-white min-h-full">
            ...
            <h2 className="font-bold text-[20px] mt-3">ทำความสะอาดทั่วไป</h2>
        ...
        <div className="mx-10 rounded-md overflow-hidden border border-[#CCD0D7]">
          ...
          <div className="p-2 md:p-5 bg-white min-h-full">
            ...
            <h2 className="font-bold text-[20px] mt-3">ล้างแอร์</h2>
            <div className="flex items-center">
              <SellBlack />
              <p className="ml-2 text-[#646C80]">
                ค่าบริการประมาณ 500.00 - 1,000.00 ฿
        ...
        <div className="rounded-md overflow-hidden border border-[#CCD0D7]">
          ...
          <div className="p-2 md:p-5 bg-white min-h-full">
            ...
            <h2 className="font-bold text-[20px] mt-3">ซ่อมเครื่องซักผ้า</h2>
            <div className="flex items-center">
              <SellBlack />
              <p className="ml-2 text-[#646C80]">ค่าบริการประมาณ 500.00 ฿</p>
            </div>
